...
|---|---|---|---|---|---|
| [ai.airshelf/catalog](https://live-vps.sasame.online/directory/mcp-airshelf-ai-mcp.html) | A | observed | `https://mcp.airshelf.ai/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/mcp-airshelf-ai-mcp.json) | returns real content |
...
| [ai.inxy/seo-audit](https://live-vps.sasame.online/directory/inxy-ai-api-mcp.html) | A | observed | `https://inxy.ai/api/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/inxy-ai-api-mcp.json) | returns real content |
| [ai.jeda/jeda-ai](https://live-vps.sasame.online/directory/mcp-jeda-ai-mcp.html) | A | observed | `https://mcp.jeda.ai/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/mcp-jeda-ai-mcp.json) | returns real content |
| [ai.masnavi/masnavi](https://live-vps.sasame.online/directory/masnavi-ai-mcp.html) | A | observed | `https://masnavi.ai/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/masnavi-ai-mcp.json) | returns real content |
| [ai.maxcv/resume](https://live-vps.sasame.online/directory/maxcv-ai-mcp.html) | A | observed | `https://maxcv.ai/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/maxcv-ai-mcp.json) | returns real content |
| [ai.pictomancer/image-processing](https://live-vps.sasame.online/directory/api-pictomancer-ai-mcp.html) | A | observed | `https://api.pictomancer.ai/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/api-pictomancer-ai-mcp.json) | returns real content |
| [ai.rootdata/public-directory](https://live-vps.sasame.online/directory/rootdata-ai-api-mcp.html) | A | observed | `https://rootdata.ai/api/mcp` | [cert](https://live-vps.sasame.online/observatory/certs/rootdata-ai-api-mcp.json) | returns real content |
