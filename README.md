...
- **30000** public MCP entries indexed (21477 with an auditable remote endpoint)
- **23404** audited · **3581** named rows currently meet the **Observed MCP-Ready** bar (A/B)
- **3569** signed certificates copied into this snapshot
...
_Generated 2026-07-11T04:30:40.909Z · SaSame-created measurements CC-BY; upstream metadata retains upstream terms · delist: consulting@srl-sasame.com_
