...
- **30000** public MCP entries indexed (21393 with an auditable remote endpoint)
- **23721** audited · **3631** named rows currently meet the **Observed MCP-Ready** bar (A/B)
- **3619** signed certificates copied into this snapshot
...
_Generated 2026-07-12T04:30:46.441Z · SaSame-created measurements CC-BY; upstream metadata retains upstream terms · delist: consulting@srl-sasame.com_
